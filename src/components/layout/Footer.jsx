...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-t from-[#602911] to-[#160A05]  text-white px-4 sm:px-6 py-12 md:px-8 lg:px-20 overflow-hidden">
      {/* Background Image */}
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-2xl sm:text-3xl font-bold mb-2">Subscribe for Tech Insights</h2>
            <p className="text-gray-400 max-w-lg mx-auto lg:mx-0">
              No spam, just useful content on web dev, freelancing & tools I love.
            </p>
          </div>
  ...
  Subscribe
        ...
        >
          ...
          <div className="lg:w-1/5">
            ...
            <p className="text-sm text-gray-100">
              Building clean, fast & scalable web solutions for startups, agencies, and solo founders.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:gap-28 lg:justify-center">
            <div>
              <h4 className="font-semibold mb-3 text-base sm:text-sm">Services</h4>
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li><Link href="#" className="hover:text-white transition">Technical SEO</Link></li>
                <li><Link href="#" className="hover:text-white transition">API Integration</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="font-semibold mb-3 text-base sm:text-sm">Projects</h4>
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li><Link href="#" className="hover:text-white transition">GitHub Repos</Link></li>
                <li><Link href="#" className="hover:text-white transition">CodePen Experiments</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="font-semibold mb-3 text-base sm:text-sm">Support</h4>
              <ul className="space-y-2 text-sm text-gray-300">
                <li><Link href="#" className="hover:text-white transition">Hire Me</Link></li>
            ...
            <div>
              <h4 className="font-semibold mb-3 text-base sm:text-sm">Contact</h4>
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:Pranavdwivedi07@gmail.com" className="hover:text-white transition">
                    Pranavdwivedi07@gmail.com
                  </a>
                </li>
                <li className="flex items-center gap-2">
                  <FaPhone className="text-gray-400" />
                  <a href="tel:+918770676950" className="hover:text-white transition">
                    +91 8770676950
                  </a>
                </li>
              </ul>
        ...
        >
          ...
          <div className="flex space-x-4 text-lg text-gray-300 order-1 md:order-2">
            ...
            <a href="#" className="hover:text-white transition" aria-label="LinkedIn"><FaLinkedin /></a>
            <a href="#" className="hover:text-white transition" aria-label="GitHub"><FaGithub /></a>
            <a href="#" className="hover:text-white transition" aria-label="Dribbble"><FaDribbble /></a>
            <a href="#" className="hover:text-white transition" aria-label="CodePen"><FaCodepen /></a>
            <a href="#" className="hover:text-white transition" aria-label="Email"><FaEnvelope /></a>
          </div>
        </motion.div>
      </div>
    </footer>
