...
export default function OurTeam() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#4f1707] to-[#2B0C02] py-20 px-4 overflow-hidden">
        ...
        <div className="relative flex items-center justify-center perspective-1000">
                ...
                >
                  {/* Card */}
                    ...
                    <div className="relative mb-6">
                      ...
                      <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r animate-pulse"></div>
                    </div>
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 z-40 p-3 bg-orange-500/20 hover:bg-orange-500/40 backdrop-blur-sm border border-orange-500/30 rounded-full transition-all duration-200 group"
          >
            <ChevronLeft className="w-6 h-6 text-orange-300 group-hover:text-white" />
          </button>
          
          <button
            onClick={nextSlide}
            className="absolute right-4 z-40 p-3 bg-orange-500/20 hover:bg-orange-500/40 backdrop-blur-sm border border-orange-500/30 rounded-full transition-all duration-200 group"
          >
            <ChevronRight className="w-6 h-6 text-orange-300 group-hover:text-white" />
          </button>
        </div>
