  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen flex items-center justify-center px-4 md:px-6 lg:px-6 pb-0 sm:pb-6 md:pb-12 lg:pb-24">   
        ...
        >
          {/* Mobile Layout - Photo after name */}
          <div className="lg:hidden flex flex-col items-center">
            ...
            <div className="relative w-56 h-56 sm:w-64 sm:h-64 mb-6">
              ...
              >
                ...
                >
                  <Image
                    src={profilePhoto}
                    alt="Pranav Dwivedi - Full Stack Developer & AI Engineer"
                    fill
            ...
            <motion.p
              ...
              className="text-base text-gray-300 leading-relaxed mb-6 text-center max-w-2xl mx-auto"
            >
              {data.description}
            </motion.p>
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-3 mb-6 w-full max-w-sm mx-auto"
            >
              <div className="flex-1 flex items-center gap-3 p-3 bg-gray-900/40 rounded-xl border border-gray-800/50 hover:border-blue-500/30 transition-all duration-300">
            ...
            >
              <motion.button
                ...
                className="group flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl font-medium hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
              >
              ...
              <Link href="/contact" className="w-full sm:w-auto">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="group flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-900/50 text-white border border-gray-700 rounded-xl font-medium hover:bg-gray-800/50 hover:border-gray-600 transition-all duration-300 w-full"
                >
              ...
              <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96">
                ...
                >
                  <motion.div
                    ...
                    className="relative w-full h-full rounded-full overflow-hidden"
                  >
                    {/* FIX: Added explicit width and height */}
                    <div className="relative w-full h-full">
                      <Image
                        ...
                        // Try adding unoptimized if image still not showing
                        unoptimized={false}
                        // Or try a different approach with static import
                      />
                    </div>
                  </motion.div>
